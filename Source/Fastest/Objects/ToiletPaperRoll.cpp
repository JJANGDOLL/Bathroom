...
void AToiletPaperRoll::BeginPlay()
{
	Super::BeginPlay();
...
void AToiletPaperRoll::OffFocused()
{
	Mesh->SetRenderCustomDepth(false);

}

void AToiletPaperRoll::OnFocused()
{
	Mesh->SetRenderCustomDepth(true);
}

void AToiletPaperRoll::ZoomIn(FVector ScreenCenter)
{
	OffFocused();
